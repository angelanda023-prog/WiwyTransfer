...
public nonisolated enum Securegcm_AppleDeviceDiagonalMils: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
public nonisolated enum Securegcm_DeviceType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case unknown = 0
  case android = 1
  case chrome = 2
  case ios = 3
...
public nonisolated enum Securegcm_SoftwareFeature: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
public nonisolated enum Securegcm_InvocationReason: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
public nonisolated enum Securegcm_Type: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case enrollment = 0
  case tickle = 1
  case txRequest = 2
  case txReply = 3
...
public nonisolated struct Securegcm_GcmDeviceInfo: @unchecked Sendable {
  ...
  public var hasDeviceModel: Bool {_storage._deviceModel != nil}
  /// Clears the value of `deviceModel`. Subsequent reads from it will return its default value.
  public mutating func clearDeviceModel() {_uniqueStorage()._deviceModel = nil}
  ...
  public var hasLocale: Bool {_storage._locale != nil}
  ...
  public var usingSecureScreenlock: Bool {
    get {_storage._usingSecureScreenlock ?? false}
    set {_uniqueStorage()._usingSecureScreenlock = newValue}
  }
  /// Returns true if `usingSecureScreenlock` has been explicitly set.
  public var hasUsingSecureScreenlock: Bool {_storage._usingSecureScreenlock != nil}
  /// Clears the value of `usingSecureScreenlock`. Subsequent reads from it will return its default value.
  public mutating func clearUsingSecureScreenlock() {_uniqueStorage()._usingSecureScreenlock = nil}

  /// Is auto-unlocking the screenlock (e.g., when at "home") supported?
  public var autoUnlockScreenlockSupported: Bool {
    get {_storage._autoUnlockScreenlockSupported ?? false}
  ...
  public var hasAutoUnlockScreenlockSupported: Bool {_storage._autoUnlockScreenlockSupported != nil}
  /// Clears the value of `autoUnlockScreenlockSupported`. Subsequent reads from it will return its default value.
  public mutating func clearAutoUnlockScreenlockSupported() {_uniqueStorage()._autoUnlockScreenlockSupported = nil}

  /// Is auto-unlocking the screenlock (e.g., when at "home") enabled?
  public var autoUnlockScreenlockEnabled: Bool {
    get {_storage._autoUnlockScreenlockEnabled ?? false}
  ...
  /// See b/32212161.
  public var isScreenlockStateFlaky: Bool {
    get {_storage._isScreenlockStateFlaky ?? false}
    set {_uniqueStorage()._isScreenlockStateFlaky = newValue}
  }
  /// Returns true if `isScreenlockStateFlaky` has been explicitly set.
  public var hasIsScreenlockStateFlaky: Bool {_storage._isScreenlockStateFlaky != nil}
  /// Clears the value of `isScreenlockStateFlaky`. Subsequent reads from it will return its default value.
  public mutating func clearIsScreenlockStateFlaky() {_uniqueStorage()._isScreenlockStateFlaky = nil}

  /// A list of multi-device software features supported by the device.
  public var supportedSoftwareFeatures: [Securegcm_SoftwareFeature] {
    get {_storage._supportedSoftwareFeatures}
...
public nonisolated struct Securegcm_GcmMetadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var type: Securegcm_Type {
    get {_type ?? .enrollment}
    set {_type = newValue}
  }
...
public nonisolated struct Securegcm_Tickle: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Securegcm_LoginNotificationInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate nonisolated let _protobuf_package = "securegcm"

nonisolated extension Securegcm_AppleDeviceDiagonalMils: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}`>APPLE_PHONE\0\u{2}|<APPLE_PAD\0")
}

nonisolated extension Securegcm_DeviceType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}ANDROID\0\u{1}CHROME\0\u{1}IOS\0\u{1}BROWSER\0\u{1}OSX\0")
}

nonisolated extension Securegcm_SoftwareFeature: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_FEATURE\0\u{1}BETTER_TOGETHER_HOST\0\u{1}BETTER_TOGETHER_CLIENT\0\u{1}EASY_UNLOCK_HOST\0\u{1}EASY_UNLOCK_CLIENT\0\u{1}MAGIC_TETHER_HOST\0\u{1}MAGIC_TETHER_CLIENT\0\u{1}SMS_CONNECT_HOST\0\u{1}SMS_CONNECT_CLIENT\0")
}

nonisolated extension Securegcm_InvocationReason: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Securegcm_Type: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Securegcm_GcmDeviceInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GcmDeviceInfo"
  ...
  public static func ==(lhs: Securegcm_GcmDeviceInfo, rhs: Securegcm_GcmDeviceInfo) -> Bool {
...
nonisolated extension Securegcm_GcmMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GcmMetadata"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}version\0")
  ...
  public static func ==(lhs: Securegcm_GcmMetadata, rhs: Securegcm_GcmMetadata) -> Bool {
...
nonisolated extension Securegcm_Tickle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Tickle"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}expiry_time\0")
  ...
  public static func ==(lhs: Securegcm_Tickle, rhs: Securegcm_Tickle) -> Bool {
...
nonisolated extension Securegcm_LoginNotificationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LoginNotificationInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}creation_time\0\u{1}email\0\u{1}host\0\u{1}source\0\u{3}event_type\0")
  ...
  public static func ==(lhs: Securegcm_LoginNotificationInfo, rhs: Securegcm_LoginNotificationInfo) -> Bool {
