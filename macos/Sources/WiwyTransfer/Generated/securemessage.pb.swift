...
public nonisolated enum Securemessage_SigScheme: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case hmacSha256 = 1
...
public nonisolated enum Securemessage_EncScheme: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
public nonisolated enum Securemessage_PublicKeyType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case ecP256 = 1
  case rsa2048 = 2
...
public nonisolated struct Securemessage_SecureMessage: Sendable {
...
public nonisolated struct Securemessage_Header: Sendable {
  ...
  public var hasIv: Bool {self._iv != nil}
...
public nonisolated struct Securemessage_HeaderAndBody: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Public data about this message (to be bound in the signature)
  public var header: Securemessage_Header {
    get {_header ?? Securemessage_Header()}
...
public nonisolated struct Securemessage_HeaderAndBodyInternal: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Securemessage_EcP256PublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Securemessage_SimpleRsaPublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Securemessage_DhPublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Securemessage_GenericPublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var type: Securemessage_PublicKeyType {
    get {_type ?? .ecP256}
    set {_type = newValue}
  }
  ...
  public var ecP256PublicKey: Securemessage_EcP256PublicKey {
    get {_ecP256PublicKey ?? Securemessage_EcP256PublicKey()}
    set {_ecP256PublicKey = newValue}
  }
  /// Returns true if `ecP256PublicKey` has been explicitly set.
  public var hasEcP256PublicKey: Bool {self._ecP256PublicKey != nil}
  /// Clears the value of `ecP256PublicKey`. Subsequent reads from it will return its default value.
  public mutating func clearEcP256PublicKey() {self._ecP256PublicKey = nil}

  public var rsa2048PublicKey: Securemessage_SimpleRsaPublicKey {
    get {_rsa2048PublicKey ?? Securemessage_SimpleRsaPublicKey()}
    set {_rsa2048PublicKey = newValue}
  }
  /// Returns true if `rsa2048PublicKey` has been explicitly set.
  public var hasRsa2048PublicKey: Bool {self._rsa2048PublicKey != nil}
  /// Clears the value of `rsa2048PublicKey`. Subsequent reads from it will return its default value.
  public mutating func clearRsa2048PublicKey() {self._rsa2048PublicKey = nil}

  /// Use only as a last resort
  public var dh2048PublicKey: Securemessage_DhPublicKey {
    get {_dh2048PublicKey ?? Securemessage_DhPublicKey()}
    set {_dh2048PublicKey = newValue}
  }
  /// Returns true if `dh2048PublicKey` has been explicitly set.
  public var hasDh2048PublicKey: Bool {self._dh2048PublicKey != nil}
  /// Clears the value of `dh2048PublicKey`. Subsequent reads from it will return its default value.
  public mutating func clearDh2048PublicKey() {self._dh2048PublicKey = nil}
...
fileprivate nonisolated let _protobuf_package = "securemessage"

nonisolated extension Securemessage_SigScheme: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}HMAC_SHA256\0\u{1}ECDSA_P256_SHA256\0\u{1}RSA2048_SHA256\0")
}

nonisolated extension Securemessage_EncScheme: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}NONE\0\u{1}AES_256_CBC\0")
}

nonisolated extension Securemessage_PublicKeyType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}EC_P256\0\u{1}RSA2048\0\u{1}DH2048_MODP\0")
}

nonisolated extension Securemessage_SecureMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SecureMessage"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}header_and_body\0\u{1}signature\0")
  ...
  public static func ==(lhs: Securemessage_SecureMessage, rhs: Securemessage_SecureMessage) -> Bool {
...
nonisolated extension Securemessage_Header: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Header"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}signature_scheme\0\u{3}encryption_scheme\0\u{3}verification_key_id\0\u{3}decryption_key_id\0\u{1}iv\0\u{3}public_metadata\0\u{3}associated_data_length\0")
  ...
  public static func ==(lhs: Securemessage_Header, rhs: Securemessage_Header) -> Bool {
...
nonisolated extension Securemessage_HeaderAndBody: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HeaderAndBody"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}header\0\u{1}body\0")
  ...
  public static func ==(lhs: Securemessage_HeaderAndBody, rhs: Securemessage_HeaderAndBody) -> Bool {
...
nonisolated extension Securemessage_HeaderAndBodyInternal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HeaderAndBodyInternal"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}header\0\u{1}body\0")
  ...
  public static func ==(lhs: Securemessage_HeaderAndBodyInternal, rhs: Securemessage_HeaderAndBodyInternal) -> Bool {
    if lhs._header != rhs._header {return false}
    if lhs._body != rhs._body {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
nonisolated extension Securemessage_EcP256PublicKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Securemessage_EcP256PublicKey, rhs: Securemessage_EcP256PublicKey) -> Bool {
...
nonisolated extension Securemessage_SimpleRsaPublicKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Securemessage_SimpleRsaPublicKey, rhs: Securemessage_SimpleRsaPublicKey) -> Bool {
...
nonisolated extension Securemessage_DhPublicKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Securemessage_DhPublicKey, rhs: Securemessage_DhPublicKey) -> Bool {
    if lhs._y != rhs._y {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
nonisolated extension Securemessage_GenericPublicKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Securemessage_GenericPublicKey, rhs: Securemessage_GenericPublicKey) -> Bool {
